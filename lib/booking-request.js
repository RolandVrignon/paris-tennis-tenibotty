...
).join(' → ') + (input.consecutive ? ` ; 2h consécutives (${input.bookingAccount || 'main'} puis ${input.consecutive.bookingAccount})` : input.bookingAccount ? ` ; compte ${input.bookingAccount}` : '')
