...
export const validateSportPlayers = (sport, players) => {
  if (normalizeSport(sport) === 'padel' && (!Array.isArray(players) || players.length !== 3)) {
    throw new Error('Padel requires exactly three partners in addition to the account holder')
  }
}
